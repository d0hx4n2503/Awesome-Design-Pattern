...
Đối xử leaf và group giống nhau trong cấu trúc cây.
...
Leaf và composite cùng implement component interface. Composite chứa children và delegate operation xuống cây.

## Góc nhìn thực tế

Composite không nên được dùng chỉ vì tên pattern nghe "xịn". Nó chỉ đáng dùng khi giúp code bớt phụ thuộc sai chỗ, làm thay đổi trong tương lai rẻ hơn, và tạo seam rõ ràng để test.
